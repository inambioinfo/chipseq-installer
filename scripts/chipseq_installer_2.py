...
def install_genomes():
	GRCh37Annotation = os.path.join(env.project_dir, 'annotation',"GRCh37_Ensembl")
	...
	MM10Annotation = os.path.join(env.project_dir, 'annotation',"MM10_Ensembl")
	lrun("mkdir -p %s" % (GRCh37Annotation))
...
def install_test():
	FQTest = os.path.join(env.project_dir, "test","fqdirectory")
	lrun("mkdir -p %s" % (FQTest))
	url_Rep1_lane1 = "ftp://ftp.sra.ebi.ac.uk/vol1/fastq/SRR619/SRR619469/SRR619469.fastq.gz"
	url_Rep1_lane2 = "ftp://ftp.sra.ebi.ac.uk/vol1/fastq/SRR619/SRR619470/SRR619470.fastq.gz"
	url_Rep2_lane1 = "ftp://ftp.sra.ebi.ac.uk/vol1/fastq/SRR619/SRR619471/SRR619471.fastq.gz"
	url_Rep2_lane2 = "ftp://ftp.sra.ebi.ac.uk/vol1/fastq/SRR619/SRR619472/SRR619472.fastq.gz"
	url_InputForRep1 = "ftp://ftp.sra.ebi.ac.uk/vol1/fastq/SRR619/SRR619473/SRR619473.fastq.gz"
	url_InputForRep2 = "ftp://ftp.sra.ebi.ac.uk/vol1/fastq/SRR619/SRR619474/SRR619474.fastq.gz"	
...
def update_config():
    ...
    pathToConfig = os.path.join(os.getcwd(),"BRANCH07/Process10/Config/config.ini")
    pathToConfigNew = os.path.join(os.getcwd(),"BRANCH07/Process10/Config/configNew.ini")
    if os.path.exists(pathToConfig):
	config.read(pathToConfig)
	inifile = open(pathToConfigNew,'w')


	config.set("Executables","meme",os.path.join(env.bin_dir,"/meme_4.9.0/bin/meme-chip"))
	config.set("Executables","python",os.path.join(env.bin_dir,"python"))
	config.set("Executables","perl",os.path.join(env.bin_dir,"/perl-5.18.0/bin/perl"))
	...
	config.set("Libraries","perllibs",os.path.join(env.bin_dir,"/perl-5.18.0/lib/site_perl/5.18.0/"))
	config.set("Libraries","javalibs","")

	config.set("meme parameters","tfdb","")

	config.set("Genomes","grch37",os.path.join(os.getcwd(),"/annotation/GRCh37_Ensembl/Homo_sapiens.GRCh37.67.dna.toplevel.fa"))
	config.set("Genomes","mm10",os.path.join(os.getcwd(),"/annotation/MM10_Ensembl/Mus_musculus.NCBIM37.67.dna.toplevel.fa"))
